window.onload = function (event){
	...
	var ad = document.getElementById("ad")
	    ...
	    headcountLi = headcount.getElementsByTagName("li"),
		...
		function checkTargets(){
			...
			for(var i=0; i < headcountLi.length; i++){
				
				removeClass(headcountLi[i],"full");
				
				if(targetRecount < targetsRemaining) {
					
					addClass(headcountLi[i],"full");
